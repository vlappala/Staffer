...
class Shift(db.Model):
    ...
    def find_shifts_with_sign_ups():
        stmt = text("SELECT show.name, show.show_date, shift.show_id, count(shift.show_id) AS LKM FROM shift, show where show.id = shift.show_id GROUP BY show_id ORDER BY LKM DESC;")
